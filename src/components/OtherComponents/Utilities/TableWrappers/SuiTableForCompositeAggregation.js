...
import { fetchPostJson } from '../../dashboard_snas_components_library/FetchUtils'
import BaseTable from '../../dashboard_snas_components_library/SUI_TABLE/BaseTable'

export default function SuiTableForCompositeAggregation(props) {
